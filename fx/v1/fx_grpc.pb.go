...
const (
	FxService_UpdateRates_FullMethodName = "/fx.v1.FxService/UpdateRates"
...
func (c *fxServiceClient) UpdateRates(ctx context.Context, in *UpdateRatesRequest, opts ...grpc.CallOption) (*UpdateRatesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateRatesResponse)
	err := c.cc.Invoke(ctx, FxService_UpdateRates_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedFxServiceServer) UpdateRates(context.Context, *UpdateRatesRequest) (*UpdateRatesResponse, error) {
...
func _FxService_UpdateRates_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateRatesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FxServiceServer).UpdateRates(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FxService_UpdateRates_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FxServiceServer).UpdateRates(ctx, req.(*UpdateRatesRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _FxService_UpdateRates_Handler,
		},
		{
			MethodName: "Convert",
