...
const (
	WalletService_GetRandomAccounts_FullMethodName = "/wallet.v1.WalletService/GetRandomAccounts"
	WalletService_GetAccount_FullMethodName        = "/wallet.v1.WalletService/GetAccount"
...
type WalletServiceClient interface {
	GetRandomAccounts(ctx context.Context, in *GetRandomAccountsRequest, opts ...grpc.CallOption) (*GetRandomAccountsResponse, error)
...
func (c *walletServiceClient) GetRandomAccounts(ctx context.Context, in *GetRandomAccountsRequest, opts ...grpc.CallOption) (*GetRandomAccountsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetRandomAccountsResponse)
	err := c.cc.Invoke(ctx, WalletService_GetRandomAccounts_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WalletServiceServer interface {
	GetRandomAccounts(context.Context, *GetRandomAccountsRequest) (*GetRandomAccountsResponse, error)
...
func (UnimplementedWalletServiceServer) GetRandomAccounts(context.Context, *GetRandomAccountsRequest) (*GetRandomAccountsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetRandomAccounts not implemented")
}
...
func _WalletService_GetRandomAccounts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetRandomAccountsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WalletServiceServer).GetRandomAccounts(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WalletService_GetRandomAccounts_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServiceServer).GetRandomAccounts(ctx, req.(*GetRandomAccountsRequest))
	}
...
var WalletService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetRandomAccounts",
			Handler:    _WalletService_GetRandomAccounts_Handler,
		},
		{
