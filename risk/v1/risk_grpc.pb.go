...
const (
	RiskService_Evaluate_FullMethodName = "/risk.v1.RiskService/Evaluate"
)
...
type RiskServiceClient interface {
	Evaluate(ctx context.Context, in *ScoreRequest, opts ...grpc.CallOption) (*EvaluateResponse, error)
}
...
func (c *riskServiceClient) Evaluate(ctx context.Context, in *ScoreRequest, opts ...grpc.CallOption) (*EvaluateResponse, error) {
...
type RiskServiceServer interface {
	Evaluate(context.Context, *ScoreRequest) (*EvaluateResponse, error)
...
func (UnimplementedRiskServiceServer) Evaluate(context.Context, *ScoreRequest) (*EvaluateResponse, error) {
...
func _RiskService_Evaluate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RiskServiceServer).Evaluate(ctx, req.(*ScoreRequest))
	}
